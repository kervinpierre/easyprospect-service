...
easyprospect::web::server::db_layer_t::db_with_tables_t::db_with_tables_t(
...
easyprospect::web::server::db_layer_t::db_layer_t(const char * database_name)
	:	m_db{database_name}
...
easyprospect::web::server::pet_id_t
easyprospect::web::server::db_layer_t::create_new_pet(const easyprospect::web::server::model::pet_without_id_t & pet)
{
...
easyprospect::web::server::model::all_pets_t
easyprospect::web::server::db_layer_t::get_all_pets()
{
...
nonstd::optional<easyprospect::web::server::model::pet_with_id_t>
easyprospect::web::server::db_layer_t::get_pet(easyprospect::web::server::pet_id_t id)
{
...
easyprospect::web::server::db_layer_t::update_result_t
easyprospect::web::server::db_layer_t::update_pet(pet_id_t id, const model::pet_without_id_t & pet)
{
	std::lock_guard<std::mutex> lock{m_lock};
...
easyprospect::web::server::db_layer_t::delete_result_t
easyprospect::web::server::db_layer_t::delete_pet(pet_id_t id)
{
	std::lock_guard<std::mutex> lock{m_lock};
