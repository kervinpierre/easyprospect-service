...
easyprospect_config_cmd::get_options(easyprospect_config_cmd& config)
{
    ...
    desc.add_options()("pid-file-dir", boost::program_options::value<std::string>(), "Directory for placing an autogenerated PID file");
...
void
easyprospect::service::config::easyprospect_config_core_builder::set_pid_dir_path(std::string pid_dir_path)
{
